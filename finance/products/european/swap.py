...
class SwapContract(EuropeanContract):
    def __init__(self, underlying, df_process, dates, underlying_index=0):
        super(SwapContract, self).__init__(underlying, dates[-1], 
        df_process, underlying_index)
    ...
    def price(self, t, **kwargs):
        incl_next_coupon = kwargs.get("incl_next_coupon", False)
